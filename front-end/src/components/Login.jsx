...
const Login = () => {
    ...
    const [noRecordFound, setRecordFound] = useState(false)
        ...
        <div class="flex items-center justify-center h-screen w-screen bg-030408 font-league">
            ...
            <div className=' h-2/3 w-3/5 flex text-white'>
                ...
                <form onSubmit={handleSubmit} className='bg-192231 h-full w-3/4 flex flex-col items-center justify-center rounded-r-3xl'>
                    <h1 className='text-4xl text-white absolute mb-350px font-bold'>Login</h1>
                    ...
                    <div className='mt-6 mb-4 mr-10 space-x-5'>
                        ...
                        {noRecordFound && <p>no record found</p>}
                    </div>

                    <button type="submit" className='bg-1b92a8 absolute mt-72  text-white hover:bg-white hover:text-1b92a8 px-12 py-1  rounded '>Login</button>
                    <p className='absolute mt-370px text-white'>Don't have an account? <Link to='/' className='text-1b92a8 hover:text-787C83'>Sign up</Link></p>
                </form >
            </div >
        </div>
